...
const SkeletonItem:React.FC = () => {
  return(
    <div>
    <div role="status"
         className="p-4 w-auto rounded border border-gray-200 shadow animate-pulse md:p-6 dark:border-gray-700">
      ...
      <div className="flex items-center mt-4 space-x-3">
        ...
        <div>
          ...
          <div className="w-33 h-2 bg-gray-200 rounded-full dark:bg-gray-700"></div>
        </div>
      </div>
